...
# v3.3.2 NOTE: the v3.2.12 smooth_seconds_for_delay budget (EMA funded by the
# delay window, action horizon pulled earlier by tau) lived here and is
# REMOVED. On-road verdict: an EMA redistributes each maneuver across the
...
# knots; the delay window is used by delay-compensated knots + the in-period
# interpolation below, and that is the validated feel.
