...
class DRIVER_MONITOR_SETTINGS:
  def __init__(self, device_type):
    ...
    # FunnyPilot v2.2.0: 9x DM timeouts for personal use
    self._AWARENESS_TIME = 270. # passive wheeltouch total timeout (9x: 30s → 270s)
    self._AWARENESS_PRE_TIME_TILL_TERMINAL = 135.
    self._AWARENESS_PROMPT_TIME_TILL_TERMINAL = 54.
    self._DISTRACTED_TIME = 99. # active monitoring total timeout (9x: 11s → 99s)
