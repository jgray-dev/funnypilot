...
procs = [
  ...
  PythonProcess("dmonitoringmodeld", "selfdrive.modeld.dmonitoringmodeld", driverview, enabled=False),  # FunnyPilot: DM disabled
  ...
  PythonProcess("dmonitoringd", "selfdrive.monitoring.dmonitoringd", driverview, enabled=False),  # FunnyPilot: DM disabled
...
procs += [
  ...
  # FunnyPilot: web terminal + branch flasher on port 8888
