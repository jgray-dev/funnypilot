...
_CODE_MARKERS = [
  ...
  ("def lead_urgency", "/data/openpilot/selfdrive/controls/lib/long_shaping.py", "lead-approach urgency"),
  ("class SccmVisionVeto", "/data/openpilot/sunnypilot/selfdrive/controls/lib/long_v2/vision_veto.py", "SCC-M vision veto"),
  ("pre_zone_decel_target", "/data/openpilot/sunnypilot/selfdrive/controls/lib/speed_limit/pre_zone.py", "SLA pre-zone ramps"),
  ("E2E_STOP_DECEL", "/data/openpilot/selfdrive/controls/lib/longitudinal_planner.py", "e2e stop assist"),
