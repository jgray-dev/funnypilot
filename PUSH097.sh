#!/bin/bash
# FunnyPilot v0.9.7 Push Script

set -e

DEVICE_IP="192.168.86.31"
DEVICE_USER="comma"
BRANCH="funnypilot-0.9.7"

echo "========================================="
echo "FunnyPilot v0.9.7 Push Script"
echo "========================================="
echo ""
...
echo ""
echo "========================================="
echo "✓ FunnyPilot v0.9.7 pushed successfully!"
echo "========================================="
echo ""
echo "The device will restart openpilot in a few seconds."
echo "Check the main screen for 'FunnyPilot 0.9.7' to verify."
